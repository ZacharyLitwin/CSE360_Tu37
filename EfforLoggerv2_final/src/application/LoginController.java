//Author: Alma Babbit
// Group: TU-37
//Purpose: Controls the login screen. Only moves to next screen with valid login
...
public class LoginController {
	...
	// checks the entered username and password against stored ones and populates the currentLoginID
	...
	// moves you to a new scene for adding an employee
