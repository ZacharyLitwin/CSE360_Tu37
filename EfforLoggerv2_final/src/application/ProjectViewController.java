//Author: Alma Babbit
// Group: TU-37
//Purpose: Controls the Project View Screen. Allows the creation of projects and setting what life cycle steps a project has
...
public class ProjectViewController implements Initializable {
    ...
    //-----------------------------------------------------------------------------------
	    ...
	    @FXML
	    private void toEffortLog(ActionEvent event){
	    	toeffortlog.getScene().getWindow().hide();
			Parent root;
			try {
