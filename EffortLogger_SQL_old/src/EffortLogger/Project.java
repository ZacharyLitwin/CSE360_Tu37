...
public class Project {
	...
	//Static attributes
	//These arrays of Strings could be saved elsewhere and not in the project class
	...
	public Project(String name) {
		...
		this.life_cycles = new ArrayList<String>();
	...
	public String get_life_cycle(int index) {
		return life_cycles.get(index);
	}
	...
	public void delete_effort(int index) {
		efforts.remove(index);
		number_of_efforts--;
	}
	public void delete_defect(int index) {
		defects.remove(index);
		number_of_efforts--;
	}
	
	//TODO
	//create edit methods for effort and defects
	public void edit_effort(int index1, int index2, int start, int end) {
